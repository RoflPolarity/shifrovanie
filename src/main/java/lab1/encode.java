...
public class encode {
    ...
    private ArrayList<String> code() {
        ...
        this.encodingFile = new File("/home/"+username+"/Рабочий стол/CODED.txt");
        ...
        for (String s : this.text) {
            ...
            for (Letter letter : lettersOfString) {
                ...
                try {
                    sb.append(letter.alphabet.charAt((letter.num + lettersOfKey[keyCounter].num) % letter.alphabet.length()));
                } catch (NullPointerException e) {

                    System.out.println(s);
                    System.out.println(lettersOfKey[keyCounter].num);
                    System.out.println(letter.alphabet.length());
                }
                keyCounter++;
            }
            res.add(sb.append('\n').toString());
